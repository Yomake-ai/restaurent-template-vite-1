                ...
                <div className="row">
                    <div className="col-lg-6 align-self-center">
                        <div className="sb-cta-text">
                            <h2 className="sb-h1 sb-mb-15" dangerouslySetInnerHTML={{__html : Data.title}} />
                            <p className="sb-text sb-mb-30" dangerouslySetInnerHTML={{__html : Data.description}} />

                            {/* button */}
                            <Link to={Data.button1.link} className="sb-btn">
                            ...
                            {/* button end */}
                            {/* button */}
                            <Link to={Data.button2.link} className="sb-btn sb-btn-2 sb-btn-gray">
                                <span className="sb-icon">
